...
var (
	...
	VMErrorNeedLengthOrBoundary = errors.New("Должна быть длина диапазона иличо начало и конец")
	VMErrorNeedFormatAndArgs    = errors.New("Должны быть форматная строка и хотя бы один параметр")
	VMErrorSmallDecodeBuffer    = errors.New("Мало данных го декодирования")
	...
	VMErrorNeedBinaryTyper = errors.New("Требуется значение, которое может быть сериалчоунастутовано в бинарное")
	...
	VMErrorUnknownType         = errors.New("Нечоунастутвестный тип данных")
	...
	VMErrorUnknownOperation   = errors.New("Нечоунастутвестная операция")
